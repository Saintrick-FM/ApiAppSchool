...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nomMatiere', models.CharField(default='', max_length=200, verbose_name='nom de la matière')),
                ('codeMatiere', models.CharField(default='', max_length=200, null=True, verbose_name='Code de la matière')),
                ('pluriProf', models.CharField(choices=[('Non', 'Non'), ('Oui', 'Oui')], default=('Non', 'Non'), max_length=20, verbose_name='Enseignée par plusieurs ?')),
                ('matiereDeBase', models.CharField(choices=[('Non', 'Non'), ('Oui', 'Oui')], default=('Non', 'Non'), max_length=50, null=True, verbose_name='Matiere de Base ?')),
                ...
                ('groupeMatiere', models.CharField(choices=[('MATIERE_LITTERAIRES', 'Matières litteraires'), ('MATIERE_SCIENTIFIQUES', 'Matières scientifiques'), ('AUTRES_MATIERES', 'Autres matières')], default='', max_length=100, null=True)),
